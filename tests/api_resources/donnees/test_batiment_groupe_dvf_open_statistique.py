...
class TestBatimentGroupeDvfOpenStatistique:
    ...
    def test_method_list(self, client: Bdnb) -> None:
        ...
        assert_matches_type(
            SyncDefault[BatimentGroupeDvfOpenStatistique], batiment_groupe_dvf_open_statistique, path=["response"]
        )
...
class TestAsyncBatimentGroupeDvfOpenStatistique:
    ...
    async def test_method_list(self, async_client: AsyncBdnb) -> None:
        ...
        assert_matches_type(
            AsyncDefault[BatimentGroupeDvfOpenStatistique], batiment_groupe_dvf_open_statistique, path=["response"]
        )
