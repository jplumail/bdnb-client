...
class TestBatimentGroupeDelimitationEnveloppe:
    ...
    def test_raw_response_list(self, client: Bdnb) -> None:
        response = client.donnees.batiment_groupe_delimitation_enveloppe.with_raw_response.list()
    ...
    def test_streaming_response_list(self, client: Bdnb) -> None:
        with client.donnees.batiment_groupe_delimitation_enveloppe.with_streaming_response.list() as response:
...
class TestAsyncBatimentGroupeDelimitationEnveloppe:
    ...
    async def test_method_list_with_all_params(self, async_client: AsyncBdnb) -> None:
        batiment_groupe_delimitation_enveloppe = await async_client.donnees.batiment_groupe_delimitation_enveloppe.list(
            batiment_groupe_id="batiment_groupe_id",
            code_departement_insee="code_departement_insee",
            delimitation_enveloppe_dict="delimitation_enveloppe_dict",
            limit="limit",
    ...
    async def test_raw_response_list(self, async_client: AsyncBdnb) -> None:
        response = await async_client.donnees.batiment_groupe_delimitation_enveloppe.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, async_client: AsyncBdnb) -> None:
        async with async_client.donnees.batiment_groupe_delimitation_enveloppe.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
