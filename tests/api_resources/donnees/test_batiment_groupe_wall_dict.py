...
class TestBatimentGroupeWallDict:
    ...
    def test_method_list(self, client: Bdnb) -> None:
        ...
        assert_matches_type(SyncDefault[BatimentGroupeWallDict], batiment_groupe_wall_dict, path=["response"])
...
class TestAsyncBatimentGroupeWallDict:
    ...
    async def test_method_list(self, async_client: AsyncBdnb) -> None:
        ...
        assert_matches_type(AsyncDefault[BatimentGroupeWallDict], batiment_groupe_wall_dict, path=["response"])
