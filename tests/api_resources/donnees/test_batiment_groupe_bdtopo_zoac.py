...
class TestBatimentGroupeBdtopoZoac:
    ...
    def test_method_list(self, client: Bdnb) -> None:
        ...
        assert_matches_type(SyncDefault[BatimentGroupeBdtopoZoac], batiment_groupe_bdtopo_zoac, path=["response"])
...
class TestAsyncBatimentGroupeBdtopoZoac:
    ...
    async def test_method_list(self, async_client: AsyncBdnb) -> None:
        ...
        assert_matches_type(AsyncDefault[BatimentGroupeBdtopoZoac], batiment_groupe_bdtopo_zoac, path=["response"])
