...
class TestBatimentGroupeRnc:
    ...
    def test_method_list(self, client: Bdnb) -> None:
        ...
        assert_matches_type(SyncDefault[BatimentGroupeRnc], batiment_groupe_rnc, path=["response"])
...
class TestAsyncBatimentGroupeRnc:
    ...
    async def test_method_list(self, async_client: AsyncBdnb) -> None:
        ...
        assert_matches_type(AsyncDefault[BatimentGroupeRnc], batiment_groupe_rnc, path=["response"])
