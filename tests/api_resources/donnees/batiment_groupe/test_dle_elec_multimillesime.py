...
class TestDleElecMultimillesime:
    ...
    def test_raw_response_list(self, client: Bdnb) -> None:
        response = client.donnees.batiment_groupe.dle_elec_multimillesime.with_raw_response.list()
    ...
    def test_streaming_response_list(self, client: Bdnb) -> None:
        with client.donnees.batiment_groupe.dle_elec_multimillesime.with_streaming_response.list() as response:
...
class TestAsyncDleElecMultimillesime:
    ...
    async def test_raw_response_list(self, async_client: AsyncBdnb) -> None:
        response = await async_client.donnees.batiment_groupe.dle_elec_multimillesime.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, async_client: AsyncBdnb) -> None:
        async with async_client.donnees.batiment_groupe.dle_elec_multimillesime.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
