...
class TestBatimentGroupeDleGaz2020:
    ...
    def test_method_list(self, client: Bdnb) -> None:
        ...
        assert_matches_type(SyncDefault[BatimentGroupeDleGaz2020], batiment_groupe_dle_gaz_2020, path=["response"])
...
class TestAsyncBatimentGroupeDleGaz2020:
    ...
    async def test_method_list(self, async_client: AsyncBdnb) -> None:
        ...
        assert_matches_type(AsyncDefault[BatimentGroupeDleGaz2020], batiment_groupe_dle_gaz_2020, path=["response"])
