...
class TestBatimentGroupeIndicateurReseauChaudFroid:
    ...
    def test_method_list_with_all_params(self, client: Bdnb) -> None:
        batiment_groupe_indicateur_reseau_chaud_froid = client.donnees.batiment_groupe_indicateur_reseau_chaud_froid.list(
    ...
    def test_raw_response_list(self, client: Bdnb) -> None:
        response = client.donnees.batiment_groupe_indicateur_reseau_chaud_froid.with_raw_response.list()
    ...
    def test_streaming_response_list(self, client: Bdnb) -> None:
        with client.donnees.batiment_groupe_indicateur_reseau_chaud_froid.with_streaming_response.list() as response:
...
class TestAsyncBatimentGroupeIndicateurReseauChaudFroid:
    ...
    async def test_method_list(self, async_client: AsyncBdnb) -> None:
        ...
        assert_matches_type(
            AsyncDefault[BatimentGroupeIndicateurReseauChaudFroid],
            batiment_groupe_indicateur_reseau_chaud_froid,
            path=["response"],
        )
    ...
    async def test_method_list_with_all_params(self, async_client: AsyncBdnb) -> None:
        batiment_groupe_indicateur_reseau_chaud_froid = await async_client.donnees.batiment_groupe_indicateur_reseau_chaud_froid.list(
            batiment_groupe_id="batiment_groupe_id",
            code_departement_insee="code_departement_insee",
            consommation_chaleur_par_rapport_distance_au_reseau="consommation_chaleur_par_rapport_distance_au_reseau",
            id_reseau="id_reseau",
    ...
    async def test_raw_response_list(self, async_client: AsyncBdnb) -> None:
        response = await async_client.donnees.batiment_groupe_indicateur_reseau_chaud_froid.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, async_client: AsyncBdnb) -> None:
        async with async_client.donnees.batiment_groupe_indicateur_reseau_chaud_froid.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
