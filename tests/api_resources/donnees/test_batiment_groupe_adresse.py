...
class TestBatimentGroupeAdresse:
    ...
    def test_method_list(self, client: Bdnb) -> None:
        ...
        assert_matches_type(SyncDefault[BatimentGroupeAdresse], batiment_groupe_adresse, path=["response"])
...
class TestAsyncBatimentGroupeAdresse:
    ...
    async def test_method_list(self, async_client: AsyncBdnb) -> None:
        ...
        assert_matches_type(AsyncDefault[BatimentGroupeAdresse], batiment_groupe_adresse, path=["response"])
