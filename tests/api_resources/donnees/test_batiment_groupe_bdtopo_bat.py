...
class TestBatimentGroupeBdtopoBat:
    ...
    def test_method_list(self, client: Bdnb) -> None:
        ...
        assert_matches_type(SyncDefault[BatimentGroupeBdtopoBat], batiment_groupe_bdtopo_bat, path=["response"])
...
class TestAsyncBatimentGroupeBdtopoBat:
    ...
    async def test_method_list(self, async_client: AsyncBdnb) -> None:
        ...
        assert_matches_type(AsyncDefault[BatimentGroupeBdtopoBat], batiment_groupe_bdtopo_bat, path=["response"])
