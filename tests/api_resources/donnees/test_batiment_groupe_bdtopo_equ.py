...
class TestBatimentGroupeBdtopoEqu:
    ...
    def test_method_list(self, client: Bdnb) -> None:
        ...
        assert_matches_type(SyncDefault[BatimentGroupeBdtopoEqu], batiment_groupe_bdtopo_equ, path=["response"])
...
class TestAsyncBatimentGroupeBdtopoEqu:
    ...
    async def test_method_list(self, async_client: AsyncBdnb) -> None:
        ...
        assert_matches_type(AsyncDefault[BatimentGroupeBdtopoEqu], batiment_groupe_bdtopo_equ, path=["response"])
