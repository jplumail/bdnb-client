...
from bdnb_client._constants import RAW_RESPONSE_HEADER
from bdnb_client._exceptions import APIStatusError, APITimeoutError, APIResponseValidationError
...
class TestBdnb:
    ...
    def test_multipart_repeating_array(self, client: Bdnb) -> None:
        request = client._build_request(
    ...
    def test_base_url_trailing_slash(self, client: Bdnb) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: Bdnb) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: Bdnb) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        respx_mock.get("/donnees/batiment_groupe").mock(side_effect=httpx.TimeoutException("Test timeout error"))

        with pytest.raises(APITimeoutError):
            self.client.get(
                "/donnees/batiment_groupe", cast_to=httpx.Response, options={"headers": {RAW_RESPONSE_HEADER: "stream"}}
            )
    ...
    def test_retrying_status_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        respx_mock.get("/donnees/batiment_groupe").mock(return_value=httpx.Response(500))
...
class TestAsyncBdnb:
    ...
    def test_multipart_repeating_array(self, async_client: AsyncBdnb) -> None:
    ...
    def test_base_url_trailing_slash(self, client: AsyncBdnb) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncBdnb) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncBdnb) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_retries_taken(
        self, async_client: AsyncBdnb, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
