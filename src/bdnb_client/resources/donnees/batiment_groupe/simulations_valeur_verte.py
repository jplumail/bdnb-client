...
class SimulationsValeurVerteResourceWithRawResponse:
    def __init__(self, simulations_valeur_verte: SimulationsValeurVerteResource) -> None:
        self._simulations_valeur_verte = simulations_valeur_verte

        self.list = to_raw_response_wrapper(
            simulations_valeur_verte.list,
        )


class AsyncSimulationsValeurVerteResourceWithRawResponse:
    def __init__(self, simulations_valeur_verte: AsyncSimulationsValeurVerteResource) -> None:
        self._simulations_valeur_verte = simulations_valeur_verte
...
class SimulationsValeurVerteResourceWithStreamingResponse:
    def __init__(self, simulations_valeur_verte: SimulationsValeurVerteResource) -> None:
        self._simulations_valeur_verte = simulations_valeur_verte
...
class AsyncSimulationsValeurVerteResourceWithStreamingResponse:
    def __init__(self, simulations_valeur_verte: AsyncSimulationsValeurVerteResource) -> None:
        self._simulations_valeur_verte = simulations_valeur_verte
