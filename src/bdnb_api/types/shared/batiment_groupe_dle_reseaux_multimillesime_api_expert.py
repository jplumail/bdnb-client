...
__all__ = ["BatimentGroupeDleReseauxMultimillesimeAPIExpert"]


class BatimentGroupeDleReseauxMultimillesimeAPIExpert(BaseModel):
    ...
    identifiant_reseau: Optional[List[str]] = None
    ...
    type_reseau: Optional[List[str]] = None
